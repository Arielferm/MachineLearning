...
num_samples = 1000
features = np.random.rand(num_samples, 3)  # 3 características predictoras
...
print("Precisión del modelo KNN en datos de entrenamiento:", accuracy_train)

"""# Ejemplo con evaluación de n° de k"""
...
# Definir los valores de k para la validación cruzada k-fold
k_values = range(2, 11)  # Probaremos k desde 2 hasta 10

# Lista para almacenar los puntajes de validación cruzada promedio para cada valor de k
mean_scores = []

# Realizar validación cruzada k-fold para cada valor de k
for k in k_values:
    ...
    # Calcular el puntaje medio de la validación cruzada
...
# Entrenar el modelo con el mejor valor de k y predecir usando validación cruzada
...
# Si es un problema de clasificación binaria, podemos graficar la curva ROC y calcular el AUC
...
La validación cruzada k-fold divide el conjunto de datos en
𝑘 subconjuntos (o "pliegues") de tamaño aproximadamente igual. Luego, el proceso de entrenamiento y evaluación se repite
𝑘
k veces, utilizando un pliegue diferente como conjunto de prueba en cada iteración y los
𝑘
−
1
k−1 pliegues restantes como conjunto de entrenamiento. Al final, los resultados de las
𝑘
k evaluaciones se promedian para obtener una estimación del rendimiento del modelo.



Interpretación de los Resultados

* Reporte de Clasificación: https://medium.com/@chanakapinfo/classification-report-explained-precision-recall-accuracy-macro-average-and-weighted-average-8cd358ee2f8a
"""
